...
export const getDynamicPrompt = (style: string = "Modern Minimalist") => `
...
3) TOP-DOWN ONLY: True 90-degree orthographic top-down view. No perspective tilt.
...
- Design Style: **${style}**. Apply this aesthetic strictly to all furniture, flooring, cabinetry, and materials.
- Lighting: Bright, natural daylight with even overhead lighting to prevent mismatched shadows. High clarity and balanced contrast.
- Finish: Professional architectural visualization. 
- Exclusions: No sketch/hand-drawn look, no watermarks, no logos, no color fringes on edges, no text.
`;